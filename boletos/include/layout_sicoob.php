    ...
    <tbody>
        <tr>
            <td class=cp width=150> 
                <!-- <span class="campo"><IMG src="../boletos/imagens/logosicoob.jpg" width="140" height="37" border=0></span> -->
                <span class="campo"><IMG src="../common/img/sos_menor.png" width="97" height="50" border=0 ></span>
            </td>
            ...
            <td width=3 valign=bottom><img height=22 src=../boletos/imagens/3.png width=2 border=0></td>
...
</tr><tr><td valign=top width=7 height=1><img height=1 src=../boletos/imagens/2.png width=7 border=0></td><td valign=top width=659 height=1><img height=1 src=../boletos/imagens/2.png width=659 border=0></td></tr></tbody></table>
...
<div align=right>Corte na linha pontilhada</div></td></tr><tr><td class=ct width=666><img height=1 src=../boletos/imagens/6.png width=665 border=0></td></tr></tbody></table>
 -->

<br>
<table cellspacing=0 cellpadding=0 width=666 border=0><tr><td class=cp width=150> 
  <span class="campo"><IMG 
      src="../boletos/imagens/logosicoob.jpg" width="140" height="37"
      border=0></span></td>
...
<table cellspacing=0 cellpadding=0 border=0>
    <tbody>
        ...
        <tr>
            <td class=cp valign=top width=7 height=12><img height=12 src=../boletos/imagens/1.png width=1 border=0></td>
            <td class=cp valign=top width=472 height=12>Pagável em qualquer banco até a data de vencimento</td>
            <td class=cp valign=top width=7 height=12><img height=12 src=../boletos/imagens/1.png width=1 border=0></td>
        ...
        <tr>
            ...
            <td class=cp valign=top align=right width=180 height=12> 
                <span class="campo">
                    ...
                    <?php echo $dadosboleto["agencia"]."/".$dadosboleto["identificador"]?>
                </span>
            </td>
        </tr>
        <tr>
...
<table cellspacing=0 cellpadding=0 border=0>
    <tbody>
        ...
        <tr>
            <td colspan=12 valign=top width=665 height=1><img height=1 src=../boletos/imagens/2.png width=666 border=0></td>
        </tr>
    </tbody>
</table>
...
<table cellspacing=0 cellpadding=0 border=0>
    <tbody>
        <tr> 
            ...
            <td class=ct valign=top width=7 height=13> <img height=13 src=../boletos/imagens/1.png width=1 border=0></td>
            <td class=ct valign=top width=113height=13> Uso do Banco</td>
            <td class=ct valign=top width=7 height=13> <img height=13 src=../boletos/imagens/1.png width=1 border=0></td>
...
<table cellspacing=0 cellpadding=0 border=0>
    <tbody>
        ...
        <tr>
            <td class=cp valign=top width=7 height=44><img height=44 src=../boletos/imagens/1.png width=1 border=0></td>
