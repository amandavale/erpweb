...
/*<!--.documento { height:27cm; position:relative }*/
			...
			<table cellspacing=0 cellpadding=0 border=0>
				<tr>
					<td colspan=3 class=ct height=13>
						Sacado: <span class="cabecalho"><?php echo $dadosboleto["nome_cliente"]; ?></span>
					</td>
				</tr>
 
 				<tr>
					<td class="ct informacao_cabecalho">Cedente</td>
					<td class="ct informacao_cabecalho">Agência/Código do Cedente</td>
