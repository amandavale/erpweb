<?php
  ...
  $conf['area'] = "Consulta - Orçamentos "; // área
          ...
          case "listar":
            ...
            if($_POST['for_chk']) {
              ...
              $filtro = "WHERE 
                          ...
                          DATE(ORC.datahoraCriacao) >= '".$_POST['data_1']."'
                          AND DATE(ORC.datahoraCriacao) <= '".$_POST['data_2']."'
                          AND ORC.tipoOrcamento = 'O' AND ORC.idmotivo_cancelamento is null";
              $ordem = " Order by ORC.datahoraCriacao ASC, ORC.idorcamento";
  ...
  $smarty->display("adm_consulta_orcamento.tpl");
?>
