<?php
  ...
  $conf['area'] = "Consulta - Saída de Mercadoria do Estoque"; // área
        ...
        switch($flags['action']) {
          ...
          case "listar":
            ...
            if($_POST['for_chk']) {
              ...
              {
                $filtro = "WHERE 
                            TRNFL.idfilial_remetente = ".$_SESSION['idfilial_usuario']." AND
                ...
                $list_movimentacao = $transferencia_filial_produto->make_list_movimentacao_saida(0,9999999,$filtro,$ordem);
              ...
              else
              {
                ...
                $list_movimentacao2 = $orcamento_produto->make_list_consulta_venda_produto(0,9999999,$filtro);
  ...
  $smarty->display("adm_consulta_movimentacao_mes_saida.tpl");
?>