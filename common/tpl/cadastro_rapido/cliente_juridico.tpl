<form  action="{$smarty.server.PHP_SELF}?ac=adicionar" method="post" name = "for_cliente_juridico" id = "for_cliente_juridico">
	...
	<table width="95%" align="center">
		...
		<tr>
            <td width="30%" class="" align="right">Nome do Contato:</td>
        ...
        <tr><td>&nbsp;</td></tr>
         ...
         <tr>
             <td align="center" colspan="2">
                <input type='button' class="botao_padrao" value="ADICIONAR" name = "Adicionar" id = "Adicionar" onClick="xajax_Cadastro_Rapido_ClienteJuridico_AJAX(xajax.getFormValues('for_cliente_juridico'));" />
             	<input type='button' class="botao_padrao" value="CANCELAR" name = "CancelarJuridico" id = "CancelarJuridico" onClick="fecharLightbox(cliente_conteudo)" />
             </td>
         </tr>
