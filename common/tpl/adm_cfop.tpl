  ...
  {if $flags.action == "listar"}
    ...
    {include file="div_instrucoes_fim.tpl"}
      ...
      <input type="hidden" name="for_chk" id="for_chk" value="1" />
				...
				<tr>
					<td class="req" align="right">Código do CFOP:</td>
					<td><input class="short" type="text" name="litcodigo" id="litcodigo" maxlength="4" value="{$info.litcodigo}"/></td>
				</tr>
    ...
    {include file="div_instrucoes_fim.tpl"}
      ...
      <input type="hidden" name="for_chk" id="for_chk" value="1" />
				...
				<tr>
					<td class="req" align="right">Código do CFOP:</td>
					<td><input class="short" type="text" name="codigo" id="codigo" maxlength="4" value="{$smarty.post.codigo}"/></td>
				</tr>
				
				<tr>
					<td class="req" align="right">Descrição do CFOP:</td>
					<td><input class="long" type="text" name="descricao" id="descricao" maxlength="100" value="{$smarty.post.descricao}"/></td>
				</tr>
