      ...
      <input type="hidden" name="for_chk" id="for_chk" value="1" />
        ...
        <tr><td>&nbsp;</td></tr>
        	...
        	<td align="center" colspan="2">
        		...
        		<input name="Submit" type="submit" class="botao_padrao" value="EXCLUIR" onClick="return(confDelete('for','{$smarty.server.PHP_SELF}?ac=excluir&idestado={$info.idestado}','ATENÇÃO! Confirma a exclusão ?'))" >
        	</td>
        </tr>
