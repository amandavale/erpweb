	...
	{/if}
  	...
  	<form  action="{$smarty.server.PHP_SELF}?ac=listar" method="post" name="for_conta_receber" id="for_conta_receber">
       ...
       <tr>
		        ...
		        <tr bgcolor="#F7F7F7">
							<td colspan="9" align="center">Busca de <b>Contas a Receber</b></td>
		        </tr>
						...
						<td align="right" width="25%">Tipo de Conta: </td>
							...
							<td colspan="2" align="left">Data de vencimento: 
		...
		{section name=i loop=$list_vendas}
			...
			<table width="100%">
				...
				{if $list_vendas[i].idorcamento}
					...
					<tr bgcolor="#F7F7F7">
						<td colspan="9" align="center">Informa��es da <b>Venda</b></td>
					</tr>
	
					<tr>
						<td align="center">
							C�digo da Venda: {$list_vendas[i].idorcamento}
						</td>
	
						<td align="center">
							N� da Nota: {$list_vendas[i].numeroNota}
						</td>
						...
						<td align="center">
							Data da Cria��o: {$list_vendas[i].datahoraCriacao}
						</td>
	
						<td align="center">
							Vendedor Respons�vel: {$list_vendas[i].funcionario_criou_orcamento}
						</td>
					</tr>
				...
				{else}
					...
					<tr bgcolor="#F7F7F7">
						<td colspan="9" align="center">Informa��es da <b>Conta a Receber Avulsa</b></td>
					</tr>
