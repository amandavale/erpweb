<?php
	...
	$falha['associar_comunicado'] = 'Falha ao associar os condomínios ao comunicado.';
	$falha['salvar_arquivo'] = "Houve um erro ao salvar o arquivo %s.";
	$falha['arquivo_nao_reconhecido'] = "O arquivo %s não foi reconhecido e não foi salvo.";
	$falha['associacao_movimento_arquivo'] = 'Falha ao associar movimentos ao arquivo de remessa.';	

	$falha['listar_conteudo_retorno'] = 'Falha ao interpretar o conteúdo do arquivo de retorno.';
	$falha['listar_conteudo_pre_critica'] = 'Falha ao interpretar o conteúdo do arquivo de pré-crítica.';
	
	$conf['texto_email_comunicado_disponivel'] = "Prezado(a) %s, \n\nEstá disponível para visualização o comunicado \"%s\", criado em %s." . 
												"\n\nAtencionsamente, \n\n SOS Prestadora";
	
	$erro_validacao['nenhum_movimento_selecionado'] = 'Nenhum movimento foi selecionado.';
	$erro_validacao['arquivo_retorno'] = 'O arquivo de retorno fornecido é inválido.';
