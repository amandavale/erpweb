<?php
    ...
    * construtor da classe
  	*/
		...
		*/
		function getById($idmotivo_bloqueio){
			...
			$get_sql = "	SELECT
											MBLOQ.*
										FROM
											{$conf['db_name']}motivo_bloqueio MBLOQ
										WHERE
											 MBLOQ.idmotivo_bloqueio = $idmotivo_bloqueio ";
		...
		*/
		...
		function make_list( $pg, $rppg, $filtro = "", $ordem = "", $url = ""){
			...
			if ($ordem == "") $ordem = " ORDER BY MBLOQ.motivo_bloqueio ASC";
		...
		*/
		function update($idmotivo_bloqueio, $info){
   		...
   		//varre o formulário e monta a consulta;
			...
			$update_sql .= " WHERE  idmotivo_bloqueio = $idmotivo_bloqueio ";
		...
		*/
		function delete($idmotivo_bloqueio){
			...
			$sql = "SELECT 
							...
							WHERE 
								 idmotivo_bloqueio = $idmotivo_bloqueio ";
		...
		*/
		...
		function make_list_select( $filtro = "", $ordem = " ORDER BY motivo_bloqueio ASC") {
