<?php
    ...
    * construtor da classe
  	*/
		...
		/**
		  método: DeletaContasBancariasFornecedor
		  propósito: DeletaContasBancariasFornecedor
		*/
		...
		/**
		  método: GravaContasBancariasFornecedor
		  propósito: GravaContasBancariasFornecedor
		*/
		...
		function make_list( $pg, $rppg, $filtro = "", $ordem = "", $url = ""){
			...
			if($list_q){
				...
				while($list = $db->fetch_array($list_q)){
					...
					if ($list['principal_fornecedor'] == '0') $list['principal_fornecedor'] = "Não"; 
