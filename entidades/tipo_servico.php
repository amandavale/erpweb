<?php
    ...
    * construtor da classe
  	*/
		...
		*/
		function getById($idtipo_servico){
			...
			$get_sql = "	SELECT
											TSR.*
										FROM
											{$conf['db_name']}tipo_servico TSR
										WHERE
											 TSR.idtipo_servico = $idtipo_servico ";
		...
		*/
		...
		function make_list( $pg, $rppg, $filtro = "", $ordem = "", $url = ""){
			...
			if ($ordem == "") $ordem = " ORDER BY TSR.nome_servico ASC";
		...
		*/
		function update($idtipo_servico, $info){
   		...
   		//varre o formulário e monta a consulta;
			...
			$update_sql .= " WHERE  idtipo_servico = $idtipo_servico ";
		...
		*/
		function delete($idtipo_servico){
		...
		*/
		...
		function make_list_select( $filtro = "", $ordem = " ORDER BY nome_servico ASC") {
