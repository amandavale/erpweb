  	...
  	*/
		...
		*/
		function getById($idstatus_os){
			...
			$get_sql = "	SELECT
											STS.*
										FROM
											{$conf['db_name']}status_os STS
										WHERE
											 STS.idstatus_os = $idstatus_os ";
		...
		*/
		...
		function make_list( $pg, $rppg, $filtro = "", $ordem = "", $url = ""){
			...
			if ($ordem == "") $ordem = " ORDER BY STS.nome_status_os ASC";
		...
		*/
		function update($idstatus_os, $info){
   		...
   		//varre o formulário e monta a consulta;
			...
			$update_sql .= " WHERE  idstatus_os = $idstatus_os ";
		...
		*/
		...
		function make_list_select( $filtro = "", $ordem = " ORDER BY nome_status_os ASC") {
