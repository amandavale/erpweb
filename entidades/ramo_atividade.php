<?php
    ...
    * construtor da classe
  	*/
		...
		*/
		function getById($idramo_atividade){
			...
			$get_sql = "	SELECT
											RAT.*
										FROM
											{$conf['db_name']}ramo_atividade RAT
										WHERE
											 RAT.idramo_atividade = $idramo_atividade ";
		...
		*/
		...
		function make_list( $pg, $rppg, $filtro = "", $ordem = "", $url = ""){
			...
			if ($ordem == "") $ordem = " ORDER BY RAT.descricao_atividade ASC";
		...
		*/
		function update($idramo_atividade, $info){
   		...
   		//varre o formulário e monta a consulta;
			...
			$update_sql .= " WHERE  idramo_atividade = $idramo_atividade ";
		...
		*/
		function delete($idramo_atividade){
			...
			$sql = "SELECT 
							...
							WHERE 
								 idramo_atividade = $idramo_atividade ";
		...
		*/
		...
		function make_list_select( $filtro = "", $ordem = " ORDER BY descricao_atividade ASC") {
