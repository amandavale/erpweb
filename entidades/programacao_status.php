<?php
    ...
    * construtor da classe
  	*/
		...
		*/
		function getById($idprogramacao_status){
			...
			$get_sql = "	SELECT
											PST.*
										FROM
											{$conf['db_name']}programacao_status PST
										WHERE
											 PST.idprogramacao_status = $idprogramacao_status ";
		...
		*/
		...
		function make_list( $pg, $rppg, $filtro = "", $ordem = "", $url = ""){
			...
			if ($ordem == "") $ordem = " ORDER BY PST.nome_programacao ASC";
		...
		*/
		...
		function set($info){
			...
			$set_sql = "  INSERT INTO
		                  {$conf['db_name']}programacao_status
		                    (
		...
		*/
		function update($idprogramacao_status, $info){
   		...
   		//varre o formulário e monta a consulta;
			...
			$update_sql .= " WHERE  idprogramacao_status = $idprogramacao_status ";
		...
		*/
		function delete($idprogramacao_status){
			...
			$sql = "SELECT 
							...
							WHERE 
								 idprogramacao_status = $idprogramacao_status ";
		...
		*/
		...
		function make_list_select( $filtro = "", $ordem = " ORDER BY nome_programacao ASC") {
