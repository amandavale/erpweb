  	...
  	*/
		...
		*/
		function getById($idinstrucao){
			...
			$get_sql = "	SELECT
											INST.*
										FROM
											{$conf['db_name']}boleto_instrucao INST
										WHERE
											 INST.idinstrucao = $idinstrucao ";
		...
		*/
		...
		function make_list( $pg, $rppg, $filtro = "", $ordem = "", $url = ""){
			...
			if ($ordem == "") $ordem = " ORDER BY INST.texto_instrucao ASC";
		...
		function set($info){
			...
			$set_sql = "  INSERT INTO
		                ...
		                VALUES
		                    ...
		                    '" . $info['texto_instrucao'] . "',  
												'" . $info['descricao_instrucao'] . "'   
		...
		*/
		function update($idinstrucao, $info){
   		...
   		//varre o formulário e monta a consulta;
			...
			$update_sql .= " WHERE  idinstrucao = $idinstrucao ";
		...
		*/
		...
		function make_list_select( $filtro = "", $ordem = " ORDER BY texto_instrucao ASC") {
		...
		//Retorna todas as instruções cadastradas dentro de um array
		function getInstrucoes(){
			
			global $conf, $db;
			
			$sql_q = $db->query('SELECT * FROM '.$conf['db_name'].'boleto_instrucao');
			
			return $db->fetch_all($sql_q);
		}
